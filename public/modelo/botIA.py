...
with open("/home/frank/sites/voicerecord/public/modelo/content.json", encoding="utf-8") as f:
    data = json.load(f)
try:
    with open("/home/frank/sites/voicerecord/public/modelo/variables.packle", "rb") as archivoPickle:    
    ...
    with open("/home/frank/sites/voicerecord/public/modelo/variables.packle", "wb") as archivoPickle:    
...
try:
    modelo.load("/home/frank/sites/voicerecord/public/modelo/modleo.tflearn")
except:
    modelo.fit(entrenamiento, salida, n_epoch=1000, batch_size=10, show_metric=True)
    modelo.save("/home/frank/sites/voicerecord/public/modelo/modleo.tflearn")
